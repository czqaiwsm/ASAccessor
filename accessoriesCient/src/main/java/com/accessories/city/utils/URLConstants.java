...
//    public static final String ACBASE_HOST = "http://121.41.75.147:8081/carfashion_test";//车时尚 基础URL
    public static final String ACBASE_HOST = "http://139.224.197.56:8081/carfashion";//车时尚 基础URL
    ...
    public static final String INTEGRAL_INFO =ACBASE_URL+"/getIntegralInfo.do";//发布消息条件
