    ...
    private void initData(){
        ...
        switch (flag){
            case 11:
                ...
                break;
            case 12:
                str =   "    车易配APP构建与2016年。是致力于汽车配件、汽车用品、汽车装潢与一体的系统化、规范化、未来化的电子" +
                        "行业信息平台。\n" +
                        "    低成本、高效率、传播快是我们始终不变的服务宗旨，为客户与商户之间建立最为便捷的沟" +
                        "通桥梁是我们的职责。紧随市场电子信息化，紧跟O2O市场未来化，是我们与客户的一致追求。\n" +
                        "    我们有在为客户创造最便捷、最优惠、最齐全的汽配市场信息平台。真正的做到“一机在手，配件无忧”。";
                break;
        }
        content.setText(str);
    }
